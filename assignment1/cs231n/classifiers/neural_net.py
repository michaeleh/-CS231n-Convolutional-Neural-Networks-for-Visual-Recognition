...
class TwoLayerNet(object):
  ...
  """
    ...
    """
        ...
        # calculate w1
        w1 = X.dot(self.params['W1'])
        # adding bias
        b1 = self.params['b1']
        h1 = np.maximum(0, w1 + b1)
        # calculating w2
        w2 = np.dot(h1, self.params['W2'])
        # adding bias
        h1 = w2 + self.params['b2']
        # getting max argument index and its label
        y_pred = np.argmax(h1, axis=1)
